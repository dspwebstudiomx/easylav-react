...
const SERVICE_UI = {
  ELEMENT: {
    CLASSNAME:
      `flex flex-col gap-4 items-center justify-center shadow-2xl rounded-xl p-8 w-[100%] md:w-[180px] xl:w-[200px]  bg-light dark:border-4 dark:border-primary mx-auto`,
