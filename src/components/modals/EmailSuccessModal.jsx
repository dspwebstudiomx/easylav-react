...
const EmailSuccessModal = ({ onClick }) => {
  return (
    <Modal>
      <div className='bg-primary_light text-primary_dark text-xl p-8 py-12 xl:py-6 rounded-2xl border-2 border-primary flex gap-8 flex-col sm:flex-row items-center justify-between'>
