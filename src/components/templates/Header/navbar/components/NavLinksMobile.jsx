...
const NavLinksMobile = ({ onLinkClick }) => {
  return (
    <div className="animate__animated animate__fadeInDown absolute left-0 top-[80px] z-0 flex h-[95vh] w-full flex-col items-center justify-start overflow-hidden border-t-4 border-t-primary bg-primary dark:bg-secondary_dark px-8">
