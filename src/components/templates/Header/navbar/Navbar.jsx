...
const Navbar = () => {
  ...
  return (
    <nav
      id="nav"
      className="fixed shadow-md dark:shadow-none z-[9999] w-[100vw] h-[80px] sm:h-[90px] md:h-[100px] lg:h-[110px] flex justify-between items-center px-6 md:px-8 lg:px-12 xl:px-16 bg-light">
      <Logo />
