import { ContactForm, Container, Paragraph, Section, SEOFriendly, SocialLinks, Spacing, TitleH2 } from 'components';
        ...
        <Container>
          <div className="flex gap-6">
            <article className="animate__animated animate__bounceInLeft animate__slowest grid">
              ...
              <Paragraph>
                Nuestra forma de contacto es fácil y rápida. Puedes llenar el formulario en línea con tus preguntas y
