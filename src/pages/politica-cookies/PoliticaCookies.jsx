  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <Paragraph>
          En <span className="text-secondary_dark dark:text-secondary_light font-semibold">easylav.mx</span>, utilizamos
          cookies y tecnologías similares para mejorar la experiencia de nuestros usuarios, analizar el tráfico en
          nuestro sitio y ofrecer contenido y publicidad personalizados. Estas Políticas de Cookies explican qué son las
          cookies, cómo las usamos y cómo puedes gestionarlas.
        </Paragraph>
        ...
        <TituloYDescripcion title="1. ¿Qué son las cookies?">
          <Paragraph>
            ...
            teléfono) cuando visitas nuestro sitio web. Las cookies permiten que nuestro sitio reconozca tu dispositivo
            y recuerde información como tus preferencias o acciones realizadas previamente.
          </Paragraph>
        </TituloYDescripcion>

        <TituloYDescripcion title="2. Tipos de cookies que utilizamos">
          <Paragraph>
            En <span className="text-secondary_dark dark:text-secondary_light font-semibold">easylav.mx</span> empleamos
          ...
          <ul className="pl-6 flex flex-col gap-2">
            <li className="mb-2">
              ...
              <br /> Estas cookies son esenciales para el funcionamiento básico del sitio web y permiten funciones como
              el acceso a áreas seguras o el procesamiento de pedidos. Sin ellas, el sitio no puede funcionar
              correctamente.
            </li>
            <li className="mb-2">
              <strong className="dark:text-secondary_light">2.2 Cookies de rendimiento:</strong> <br /> Estas cookies
              recopilan información sobre cómo los usuarios interactúan con nuestro sitio, como las páginas que visitan
              con más frecuencia y posibles errores que encuentran. Esto nos ayuda a mejorar el rendimiento del sitio.
            </li>
            <li className="mb-2">
        ...
        <TituloYDescripcion title="4. ¿Cómo gestionar las cookies?">
          <Paragraph>
            Puedes gestionar tus preferencias de cookies a través de la configuración de tu navegador. La mayoría de los
          ...
          <ul className="pl-6 flex flex-col gap-2">
            ...
            <li className="mb-2">
              ...
              deshabilitar las cookies utilizadas por Google Analytics, puedes instalar el complemento de inhabilitación
              para navegadores disponible{' '}
              <a
        ...
        <TituloYDescripcion title="5. Cookies de terceros">
          <Paragraph>
            ...
            pueden usar estas cookies para sus propios fines, como análisis o publicidad. No tenemos control sobre estas
            cookies de terceros, por lo que te recomendamos revisar las políticas de privacidad y cookies de estos
            proveedores para obtener más información sobre cómo utilizan tus datos.
          </Paragraph>
        </TituloYDescripcion>
