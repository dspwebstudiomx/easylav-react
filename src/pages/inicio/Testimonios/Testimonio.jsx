...
const Testimonio = ({ testimonio }) => {
  ...
  return (
    <article
      ...
      className="pt-8 pb-2 px-8 flex flex-col justify-between bg-light text-dark rounded-xl h-[360px] sm:h-[300px] w-[80%] sm:w-full shadow-xl mx-auto border-4 border-secondary dark:border-primary"
      key={TESTIMONY_ID}>
      {/* Testimonio */}
