...
const QuieresUnaFranquicia = () => {
  ...
  return (
    <BackgroundImageSection height="h-[900px] sm:h-[700px] lg:h-[600px]" opacity={`bg-${QUIERES_UNA_FRANQUICIA_UI.BACKGROUND.COLOR} ${QUIERES_UNA_FRANQUICIA_UI.BACKGROUND.OPACITY}`} titleColor='text-primary' textColor='text-dark' image={QUIERES_UNA_FRANQUICIA_UI.DISPLAY.IMAGE} backgroundColor={QUIERES_UNA_FRANQUICIA_UI.BACKGROUND.COLOR} image_1024={images.image_1024} image_1200={images.image_1200} image_576={images.image_576} image_1920={images.image_1920} align='place-items-center'>
      <Container>

        <div id='hero-inicio_container' className={`grid md:grid-cols-1 gap-x-8`}>
          <div id='hero-inicio_info_container' className="flex flex-col gap-8 w-2/3 mx-auto">
