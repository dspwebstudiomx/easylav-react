  ...
  return (
    <Hero backgroundImage={image} textColor={'text-light'} opacity={'opacity-45'} opacityColor={'bg-dark'} height={'2xl:h-[60vh]'} titleSection={'inicio'} imageAlt='canasta de ropa verde con ropa sucia de color con fondo blanco'  >
      <Container className={'items-start w-[80vw]'}>
        ...
        <p className='text-3xl sm:text-4xl sm:w-2/3 leading-[45px] sm:leading-[60px] font-semibold'>Tu Ropa es Nuestra Pasión: Limpieza Impecable, Planchado Perfecto</p>
        <ButtonContainer>
          <ButtonSecondary title={'Nuestros Servicios'} href={'/#servicios'} border={'border-l-secondary_dark border-l-4 border-t-secondary_light border-t-4 hover:border-t-secondary hover:border-l-secondary_dark'} />
        </ButtonContainer>
      </Container>
    </Hero>
  )
