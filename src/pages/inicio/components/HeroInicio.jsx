import { VistaLavadorasySecadorasConDosMesas_640 as image_1, VistaLavanderiaDesdeEntrada_1_640 as image_2, VistaLavanderiaDesdeEntrada_2_640 as image_3 } from 'assets'
import { ButtonContainer, ButtonPrimary, Container, TitleH1 } from 'components'
...
const HeroInicio = () => {
  ...
  return (
    <section id='inicio' className={`relative overflow-hidden w-full ${HEROINICIO_UI.HEIGHT}`}>
      ...
      <div className={`absolute inset-0 z-10 w-full bg-dark opacity-60 top-0 left-0 ${HEROINICIO_UI.HEIGHT}`}></div>
