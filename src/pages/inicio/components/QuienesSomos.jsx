    ...
    <Section id="quienes-somos" className="bg-light dark:bg-dark h-auto">
      <Container className="mx-auto flex-col gap-8" id="quienes-somos-contenedor">
        ...
        <div className="flex flex-col gap-20 items-center justify-center mx-auto w-full h-full">
          ...
          {/* Misión & Visión */}
          <TwoColumnsContainer gridOrder="grid-cols-1 lg:grid-cols-2">
            {/* Misión */}
            <Card>
              <BorderLeft>
            ...
            <Card>
              ...
              <p className="text-lg text-dark">
                ...
                eficiente, capacitación continua y un enfoque en la mejora constante de procesos. Nos distinguimos por
                la innovación tecnológica, la excelencia en el servicio y la optimización de costos, garantizando un
                negocio escalable, confiable y altamente rentable para nuestros franquiciatarios.
              </p>
            </Card>
            {/* Visión */}
          </TwoColumnsContainer>
