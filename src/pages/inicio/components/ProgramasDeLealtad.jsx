...
const ProgramasDeLealtad = () => {
  ...
  const [showFront, setShowFront] = useState(true); // Para alternar entre frontal y trasera
      ...
      <Container className="mx-auto flex-col gap-20" id="quienes-somos-contenedor">
        <TwoColumnsContainer gridOrder="grid-col-reverse">
          ...
          <div className="flex flex-col items-center gap-4">
            <div
              ...
              style={{
                ...
                background: isDark
                  ? `#222 url(${showFront ? imagenFrontal : imagenTrasera}) center/cover no-repeat`
                  : `#ececec url(${showFront ? imagenFrontal : imagenTrasera}) center/cover no-repeat`,
          ...
          <ParagraphContainer>
            ...
            <ButtonContainer position="justify-start items-center w-full" distance="mt-12">
              <Button
