    ...
    <Section id="quienes-somos" className="bg-light dark:bg-dark h-auto">
      <Container className="mx-auto flex-col gap-20" id="quienes-somos-contenedor ">
          ...
          <div className="flex flex-col-reverse lg:flex-row lg:gap-16">
            ...
            <ParagraphContainer>
              ...
              <div className="md:text-xl flex flex-col gap-8 items-start justify-start">
                ...
                <span className="text-xl md:text-2xl lg:text-2xl dark:text-light">
                ...
                <span className="md:mr-6 dark:text-light">* Aplican restricciones</span>
              </div>
            </ParagraphContainer>
          </div>
        </TwoColumnsContainer>
        ...
        <article className="lg:mt-12">
          <ul className="w-full grid grid-cols-1 md:grid-cols-2 gap-12">
