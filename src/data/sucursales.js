import {
  ...
  haciendaLosOtates,
  // Placeholder,
  Placeholder as ilustresNovohispanos,
  Placeholder as laJoya,
  Placeholder as madrigalDeLasAltasTorres,
} from 'assets';
...
export const localservices = [
  ...
  },
  {
    ...
    serviceday1: 'Lunes a Domingo:',
    servicehour1: '8:00 a.m a 9:30 p.m',
    openHour: 8,
    openMinute: 0,
    closeHour: 20,
    closeMinute: 30,
  ...
  {
    id: 15,
    title: 'Ilustres Novohispanos',
    gmap: 'https://maps.app.goo.gl/BGyKGxNrgqQDPnXq7',
    position: { lat: 19.7100912, lng: -101.1521932 },
    place: 'C. Alonso Díaz 349, Ilustres Novohispanos, 58226 Morelia, Mich.',
    serviceday1: 'Lunes a Domingo:',
    servicehour1: '7:00 a.m a 9:30 p.m',
    city: 'Morelia',
    email: 'ilustres@easylav.mx',
    titleMailto: 'Enviar correo a sucursal Ilustres Novohispanos',
    advertisement: '',
    badge: 'Nueva sucursal',
    image: ilustresNovohispanos,
    openHour: 7,
    openMinute: 0,
    closeHour: 21,
    closeMinute: 30,
  },
  {
    ...
    title: 'La Joya',
    gmap: 'https://maps.app.goo.gl/BGyKGxNrgqQDPnXq7',
    position: { lat: 19.6599965, lng: -101.2048255 },
    place: 'Av. la Joya 482A, 58095 Morelia, Mich.',
    serviceday1: 'Lunes a Domingo:',
    servicehour1: '7:00 a.m a 9:30 p.m',
    city: 'Morelia',
    email: 'lajoya@easylav.mx',
    titleMailto: 'Enviar correo a sucursal La Joya',
    advertisement: '',
    badge: 'Nueva sucursal',
    image: laJoya,
    openHour: 7,
  ...
  },
  {
    ...
    gmap: 'https://maps.app.goo.gl/BGyKGxNrgqQDPnXq7',
    position: { lat: 19.7001952, lng: -101.1761543 },
    place: 'Madrigal de Las Altas Torres 218, Vasco de Quiroga, 58230 Morelia, Mich.',
    serviceday1: 'Lunes a Domingo:',
    servicehour1: '7:00 a.m a 9:30 p.m',
    city: 'Morelia',
    email: 'madrigaldelasaltastorres@easylav.mx',
    titleMailto: 'Enviar correo a sucursal Madrigal de las Altas Torres',
    advertisement: '',
    badge: 'Nueva sucursal',
    image: madrigalDeLasAltasTorres,
    openHour: 7,
    openMinute: 0,
    closeHour: 21,
    closeMinute: 30,
